...
public final class Emitter implements Emitable {
    ...
    private void expectComment() throws IOException {
        if (((CommentEvent) event).getText() == null) {
            throw new EmitterException("comment must not contain null texts");
        }
        processComment();
    }
    ...
    private void processComment() throws IOException {
        CommentEvent ev = (CommentEvent) event;
        writeIndent();
        stream.write(ev.getText());
        writeLineBreak(null);
    }
